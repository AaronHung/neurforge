...
This guide walks you through the complete process of evaluating an agent in NeurForge, from implementation to analysis.
...
```jsonl
{"instruction": "Research NeurForge and create an SVG summary"}
...
```jsonl
{"question": "What is NeurForge?", "answer": "A flexible agent framework"}
...
[1/10] Processing: Research NeurForge...
