...
NEURFORGE_LLM_API_KEY=[DeepSeek_API_key]
# Or use the DeepSeek equivalent on Tencent Cloud
# NEURFORGE_LLM_TYPE=chat.completions
# NEURFORGE_LLM_MODEL=deepseek-v3
# NEURFORGE_LLM_BASE_URL=https://api.lkeap.cloud.tencent.com/v1
# NEURFORGE_LLM_API_KEY=[DeepSeek_API_key]
...
NEURFORGE_LLM_TYPE=chat.completions
NEURFORGE_LLM_MODEL=gpt-4
NEURFORGE_LLM_BASE_URL=https://api.openai.com/v1
NEURFORGE_LLM_API_KEY=[Openai_API_key]

# For Anthropic Claude (via OpenAI-compatible API)
NEURFORGE_LLM_TYPE=chat.completions
NEURFORGE_LLM_MODEL=claude-3-sonnet-20240229
NEURFORGE_LLM_BASE_URL=[Anthropic_compatible_endpoint]
NEURFORGE_LLM_API_KEY=[Anthropic_API_key]
```
