...
This module provides the core functionality for agent practice within the NeurForge framework, implemented with Training-Free Group Relative Policy Optimization (GRPO). 
...
Please refer to the [QuickStart](https://iiotfab.github.io/neurforge/quickstart/) documentation for environment setup and installation of NeurForge framework. If you are new to Python, please refer to [Begginer's QuickStart Guide](https://iiotfab.github.io/neurforge/quickstart_beginner/) for detailed instructions. 
...
For tracing and monitoring the practice and evaluation process, you can enable Phoenix tracing by following the [Tracing & Monitoring Documentation](https://iiotfab.github.io/neurforge/environment_variables/#tracing-monitoring). For simplicity, you can start a local Phoenix server by running:
...
# PHOENIX_PROJECT_NAME=neurforge
```
...
Ensure you have an agent configuration file in `configs/agents/practice` directory. You can use built-in agents or create your own custom agent configuration. For more details, please refer to [Agent Configuration](https://iiotfab.github.io/neurforge/agents/).
