...
CUSTOMERS = [
    ("C-10001", "洪欣瑋", "FBB-500",  "2022-03-15", "新北市板橋區文化路二段"),
    ("C-10002", "粘嘉棋", "FBB-1G",   "2021-07-01", "台北市大安區仁愛路四段"),
    ("C-10003", "王繪情", "MOB-5G",   "2023-01-20", "台中市西屯區台灣大道三段"),
    ("C-10004", "王慈君", "MOB-4G",   "2020-11-05", "高雄市前鎮區中山二路"),
    ("C-10005", "戴志仲", "FBB-1G",   "2023-06-10", "台北市信義區松仁路"),
    ("C-10006", "劉遠德", "BIZ-FBB",  "2019-09-01", "新竹科學園區台積電路"),
    ("C-10007", "陳煥文", "FBB-500",  "2024-02-14", "桃園市中壢區中山路"),
    ("C-10008", "蘇永松", "MOB-5G",   "2022-08-30", "台南市東區長榮路"),
    ("C-10009", "張新助", "FBB-500",  "2021-04-22", "新北市三重區重新路"),
    ("C-10010", "黃朝全", "MOB-4G",   "2023-10-01", "彰化市中正路"),
]
...
followup_tasks = [
    ...
    },
    {
        ...
        "assigned_to": "企業客服主管",
        "priority": "critical",
        "notes": "C-10006（劉遠德）為 VIP 企業客戶，建議主管親自致電說明並道歉",
    },
    {
    ...
    },
    {
        ...
        "description": "調查 C-10002（粘嘉棋）台北大安區 1Gbps 方案速度長期不足（200-250 Mbps）的根本原因，提供解決方案",
        "assigned_to": "網路技術二組",
        "priority": "high",
